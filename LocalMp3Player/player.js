...
"Regina Spektor - Uh-Merica.m4a", 
"Frank Ocean - Swim Good.mp3"];
...
function loadSong() {
    song.src = "/Users/admin/Desktop/CODE/LocalMp3Player/playerSongs/" + songs[currentSong];
    song.play;
...
function playOrPauseSong (img) {
    ...
    if(song.paused){
        song.play();
        img.src = "/Users/admin/Desktop/CODE/LocalMp3Player/images/darkPause.png";
    }else{
        song.pause();
        img.src = "/Users/admin/Desktop/CODE/LocalMp3Player/images/darkPlay.png";
    }
}
